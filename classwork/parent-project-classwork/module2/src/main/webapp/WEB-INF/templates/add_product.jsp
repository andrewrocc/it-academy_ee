      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="/hello/add-product">Add a product</a></li>
            <li><a class="dropdown-item" href="/hello/add-department">Add a department</a></li>
            <li><a class="dropdown-item" href="/hello/add-employee">Add a employee</a></li>
            <li><a class="dropdown-item" href="/hello/add-meeting">Add a meetings</a></li>
          </ul>
        </li>
      </ul>
